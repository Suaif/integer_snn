...
for seed in seed_list:
    ...
    np.random.seed(seed)
    session_name = "mnist_stbp_snn_adam_seed_" + str(seed)
    ...
    plot_training.plot_training(train_loss, val_acc, test_acc, "./save_models/" + session_name + "/training_plot.png", title=plot_title)
