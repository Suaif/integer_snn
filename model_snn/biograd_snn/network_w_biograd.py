    ...
    def __init__(self, input_dim, output_dim, hidden_dim_list, param_dict, error_func, device, 
        ...
        for idx, hh in enumerate(hidden_dim_list, 0):
            ...
            self.hidden_cells.append(
                OnlineHiddenCell(nn.Linear(forward_input_dim, forward_output_dim, bias=False).to(device),
        ...
        self.output_cell = OnlineOutputCell(nn.Linear(input_dim_output, output_dim, bias=False).to(device),
