...
def train_biograd_shd(snn_param, hidden_dim_list, float_mode, aligned_weights, loss_mode, seed_list=0, 
    ...
    for seed in seed_list:
        ...
        train_acc, val_acc, test_acc, fb_angle, fb_ratio, best_stats = biograd_snn_training(
            ...
            writer=(False, False, True), tf_folder=tf_folder, save_folder=save_folder)
...
def train_and_evaluate(config):
    ...
    try:
        ...
        hidden_layer_dict = {'Vdecay': params['vdecay'], 'Vth': f*params['hidden_param'][0], 'Grad_win': f*params['hidden_param'][1], 'Grad_amp': 1., 
                             'lr': params['lr_hidden'], 'Weight_decay': wd_hidden, 'lr_rec': params['lr_rec'], 'Vdecay_rec': params['vdecay_rec'],
...
if __name__ == "__main__":
    ...
    # Hyperparameter grid
    grid = {
        'exp_name': ['shd_rsnn_int_16_16_v2'],
        'epochs': [50],
    ...
    max_processes = 8 # ADJUST torch.cuda.set_per_process_memory_fraction(0.15)
