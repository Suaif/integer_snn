...
if float_mode:
    ...
    out_layer_dict = {'Vdecay': 0.5, 'Vth': 0.6, 'Grad_win': 0.6, 'Grad_amp': 1., 'Fb_th': 1., 
                      'lr': 1e-3, 'Weight_decay': 0}
    hidden_layer_dict1 = {'Vdecay': 0.5, 'Vth': 0.6, 'Grad_win': 0.6, 'Grad_amp': 1., 'lr': 1e-3,
    ...
    factor = 1.
    out_layer_dict = {'Vdecay': 0.5, 'Vth': factor*1600, 'Grad_win': factor*1600, 'Grad_amp': 1., 'Fb_th': 1., 
